"""Regression checks for the meridian-algo-string-scope casebook."""
...
from casebook.harness import assert_expected, meridian_algo_string_scope_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(meridian_algo_string_scope_summary(), assert_expected())
