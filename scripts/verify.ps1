...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-meridian-algo-string-detail.ps1

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-meridian-algo-string-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-meridian-algo-string-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-meridian_algo_string_scope-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
