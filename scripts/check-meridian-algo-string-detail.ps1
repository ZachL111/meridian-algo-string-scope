...
$repo = "meridian-algo-string-scope"
$language = "OCaml"
$category = "Algorithms"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/meridian-algo-string-walkthrough.md")) {
