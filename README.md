...
meridian-algo-string-scope is a OCaml project for algorithms. It focuses on this technical goal: Package an OCaml local lab for string analysis with negative fixtures, human-readable error snapshots, and documented operating limits.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 156, risk penalty 4, latency penalty 2, and weight bonus 4. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
